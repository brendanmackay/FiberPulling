...
int TEN_1 = 20; //position variables for tension decrease in dimpling
int TEN_2 = 20;
int depth = 200; // how deep to dimple
long int DIM_P = 86800; //number of steps to dimple
unsigned long TimeD = 2000;
...
void setup() {
  ...
  electrodeRunTime = 16000;
  // Populate bezier curves slow stage
  Point accelPoints1[] = {{0, 80}, {2500,30}, {3000, 10}, {4000, -100}};
  //Point decelPoints1[] = {{8000, -200}, {8400, -200}, {8700, -0}, {8500, 0}};
  Point decelPoints1[] = {{4500, -100}, {8000, 300}, {9500, 300}, {12000, 300}};
  ...
  Point accelPoints2[] = {{0, -80}, {2500,-80}, {4000, 50}, {3900, -4000}};
  //Point decelPoints2[] = {{8000, -2000}, {8400, -200}, {8700, 0}, {8500, 0}};
  Point decelPoints2[] = {{4500, -4000}, {4500, -300}, {9500, -300}, {12000, -300}};
  ...
  if (Serial.available() > 0) {
    ...
    if (!fiberBroken){
      ...
      //dimple using the third motor
        ...
        myStepper_2.setMaxSpeed(100); // speed for motors 1 and 2
        myStepper_1.setMaxSpeed(100);
