...
class SetupGUI:
    ...
    def assign_gui_parameters(self):
        ...
        self.arduino_control.assign_parameters(Speed1_entry, Speed2_entry, Accel1_entry, Accel2_entry, Decel1_entry,
    ...
    def automate_taper_button_pressed(self):
        ...
        thread = threading.Thread(target=self.motor_control.automate_taper,
                                  args=())
        thread.start()
